class DevspaceSweeper < Formula
  ...
  on_macos do
    url "https://github.com/adwaitdeshpande/devspace-sweeper/releases/download/v0.1.3/devspace-sweeper-macos.tar.gz"
    sha256 "REPLACE_WITH_MACOS_TARBALL_SHA256"
  end

  on_linux do
    url "https://github.com/adwaitdeshpande/devspace-sweeper/releases/download/v0.1.3/devspace-sweeper-linux.tar.gz"
